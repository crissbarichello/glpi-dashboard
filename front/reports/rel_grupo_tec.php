...
<div id='content' >
	...
	<div id="charts" class="fluid chart">
		<div id="pad-wrapper" >
   		 ...
   		 <div id="titulo_rel"> <?php echo __('Tickets', 'dashboard').'  '. __('by Group', 'dashboard'). ' - '.__('Assigned'); ?>  </div>
			 <div id="datas-tec" class="span12 fluid" >
			    <form id="form1" name="form1" class="form_rel" method="post" action="rel_grupo_tec.php?con=1">
...
if($id_grp == 0) {
	...
	echo '<script language="javascript"> location.href="rel_grupo_tec.php"; </script>';
}
...
<table align='right' style='margin-bottom:10px;'>
		<tr>
			<td>
				<button class='btn btn-primary btn-sm' type='button' name='abertos' value='Abertos' onclick='location.href=\"rel_grupo_tec.php?con=1&stat=open&sel_group=".$id_grp."&date1=".$data_ini2."&date2=".$data_fin2."\"' <i class='icon-white icon-trash'></i> ".__('Opened', 'dashboard') ." </button>
				<button class='btn btn-primary btn-sm' type='button' name='fechados' value='Fechados' onclick='location.href=\"rel_grupo_tec.php?con=1&stat=close&sel_group=".$id_grp."&date1=".$data_ini2."&date2=".$data_fin2."\"' <i class='icon-white icon-trash'></i> ".__('Closed', 'dashboard')." </button>
				<button class='btn btn-primary btn-sm' type='button' name='todos' value='Todos' onclick='location.href=\"rel_grupo_tec.php?con=1&stat=all&sel_group=".$id_grp."&date1=".$data_ini2."&date2=".$data_fin2."\"' <i class='icon-white icon-trash'></i> ".__('All', 'dashboard')." </button>
			</td>
		</tr>
</table>
